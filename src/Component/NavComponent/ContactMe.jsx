...
import { FaEnvelope, FaPaperPlane, FaMapMarkerAlt, FaCheckCircle } from "react-icons/fa";
...
function ContactMe() {
  ...
  return (
    <section className="contact py-20 blueprint-grid min-h-screen flex items-center">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 text-gray-300">
                ...
                <div>
                  ...
                  <a href="mailto:chineduhilary80@gmail.com" className="text-lg hover:text-blue-400 transition-colors">
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full p-4 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-blue-500 transition-all text-white"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full p-4 h-40 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-blue-500 transition-all text-white resize-none"
                    ></textarea>
                  </div>
                  <button 
                    disabled={isSubmitting}
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 px-8 rounded-xl font-bold flex items-center justify-center gap-3 transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
                  >
